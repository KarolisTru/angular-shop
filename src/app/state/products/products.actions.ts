...
export const deleteProductError = createAction('[Products] Delete Error');

export const editProduct = createAction('[Products] Edit', props<{ id: number; productData: Product }>());
export const editProductSuccess = createAction('[Products] Edit Success', props<{ productData: Product }>());
export const editProductError = createAction('[Products] Edit Error');
